        ...
        <form onSubmit={handleSearch} className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pr-32 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#ff6b6b] focus:border-transparent"
            />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {recipes.map((recipe) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <h3 className="text-white font-semibold mb-3 line-clamp-2 group-hover:text-[#ff6b6b] transition-colors">
                        {recipe.title}
                      </h3>
